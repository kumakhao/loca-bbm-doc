...
\label{chap:lokalisierungmittelsbildverarbeitung}
  ...
  \begin{wrapfigure}{o}{0.3\textwidth}
    ...
    \label{fig:bitmuster}
  \end{wrapfigure}
In diesem Kapitel soll das in dieser Arbeit entwickelte Verfahren beschrieben werden, mit dem die Lokalisierung erfolgt. Dabei wird erklärt, wie das zu erkennende Bitmuster aufgebaut ist, wie der eingesetzte Partikelfilter ausgelegt wurde und wie der Filter die Bilder beurteilt. Im letzten Abschnitt wird auf verschiedene Parameter eingegangen, die Einstellmöglichkeiten des Filters erlauben.
\section{Bitmuster}
\label{sec:bitmuster}
