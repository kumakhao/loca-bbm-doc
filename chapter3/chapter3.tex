...
In Abbildung \ref{fig:croudEffectPlot} sind die Ergebnisse dieses Versuchs dargestellt. Der gemittelte Abstand für 0 Personen auf der Bühne entspricht dem des vorangegangenen Versuchs (bei 1500\,$ms$). Bei einer Zunahme der Personenanzahl, lässt sich ein sehr leichter Anstieg des mittleren Abstandes im Bereich 0~bis~15 Personen für die \textbf{Schlangenlinien}, \textbf{Loop~Clockwise} und der \textbf{Loop~Anticlockwise} erkennen. Für den Schritt von 15 auf 20 Personen ist, für diese drei Fahrkurven, eine stärkere Zunahme zu beobachten. Für die Fahrkurve der \textbf{Ellipse} liegt der Wert des mittleren Abstandes für 5 Personen unter dem einer Bühne ohne Personen. Eine Abnahme, bei steigender Personenzahl, ist nochmals zwischen 15 und 20 Personen zu erkennen. Den größten mittleren Abstand, über alle betrachteten Personenzahlen, weist die \textbf{Ellipse} auf, gefolgt von den \textbf{Schlangenlinien}, \textbf{Loop~Anticlockwise} und \textbf{Loop~Clockwise} (in der Reihenfolge). 
...
Über alle Fahrkurven betrachtet, steigt der mittlere Abstand zur wahren Position des Roboters mit wachsender Personenzahl. Die Ergebnisse für die \textbf{Schlangenlinien}, \textbf{Loop~Clockwise} und \textbf{Loop~Anticlockwise} verhalten sich dabei sehr ähnlich. Für die \textbf{Ellipse} sind die Ergebnisse ungewöhnlich, da der Abstand an zwei Stellen, entgegen der Erwartung sinkt. Insbesondere beim Schritt von 0 zu 5 Personen, kann dies nur durch die zufälligen Unsicherheiten der Simulation erklärt werden. Sie werden für jeden Durchlauf neu bestimmt. Daher wäre es denkbar, das unter den 15 Durchläufen mit 0 Personen zufällig schlechtere Bedingungen entstanden als dies bei den 15 Durchläufen mit 5 Personen der Fall war. Dieser Umstand könnte auch zu der Abnahme zwischen 15 und 20 Personen beigetragen haben. Für diese zweite Abnahme könnte zusätzlich die Zufällige Ziehung der Position von Personen eine mögliche Ursache sein. Abhängige von der Fahrkurve lassen sich die Positionen in zwei Gruppen gliedern:

\textbf{Positionen die das Mess-Update stören} sind alle Punkte auf der Bühne, an denen eine Person zwischen Kamera und Bit-Muster steht.

\textbf{Positionen die das Mess-Update nicht beeinflussen} sind Punkte auf der Bühne, die zu keinem Zeitpunkt auf der Fahrkurve zwischen Kamera und Bit-Muster stehen.

Bei den Ziehungen für 15 Durchläufe aus der Menge möglicher Positionen wäre es möglich überproportional viele störende oder nicht störende zu wählen. Denkbar wäre, dass das Ergebnis für die \textbf{Ellipse} bei 15 Personen zu hoch, oder bei 20 Personen zu niedrig ausfällt. 
