...
\end{equation}
Mit $\sigma_{R}$ lässt sich einstellen, wie stark die Abweichung ist. Je stärker die Radien sich unterscheiden, umso stärker scheint der Roboter bei geradeaus Fahrt zu einer Seite zu driften. Diese Art Messabweichung ist über die Dauer eine Simulation konstant, aber für jeden Simulationslauf zufällig.
